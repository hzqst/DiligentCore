...
DILIGENT_TYPED_ENUM(SHADER_RESOURCE_TYPE, Uint8)
{
    ...
    /// For D3D12 SetGraphicsRoot32BitConstants/SetComputeRoot32BitConstants or Vulkan vkCmdPushConstants, fallback to SHADER_RESOURCE_TYPE_CONSTANT_BUFFER in OpenGL and D3D11
    SHADER_RESOURCE_TYPE_32_BIT_CONSTANTS,

    SHADER_RESOURCE_TYPE_LAST = SHADER_RESOURCE_TYPE_32_BIT_CONSTANTS
};
// clang-format on
